...
replace (
	// these replacements are pinned to 2e7996e3e271 which is the sha associated with the 1.18.3 tag on k/k
	// as you cannot pin them to v1.18.3 directly
	...
	k8s.io/sample-cli-plugin => k8s.io/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20200520124240-2e7996e3e271
	k8s.io/sample-controller => k8s.io/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20200520124240-2e7996e3e271
)
