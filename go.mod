...
replace (
	// these replacements are pinned to dff82dc0de47 which is the sha associated with the 1.18.6 tag on k/k
	// as you cannot pin them to v1.18.6 directly
	...
	k8s.io/sample-cli-plugin => k8s.io/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20200715165012-dff82dc0de47
	k8s.io/sample-controller => k8s.io/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20200715165012-dff82dc0de47
)
